...
export const PdfDropzone: FC<PdfDropzoneProps> = ({
  ...
  >
    <button
      ...
      className={cn(
        "group/dz relative flex w-full min-h-[200px] flex-col items-center justify-center gap-4 rounded-[1.1rem] border border-transparent bg-gradient-to-b from-muted/30 via-background/40 to-muted/20 px-6 py-10 text-center outline-none backdrop-blur-md transition-all duration-300 sm:min-h-[228px]",
    ...
    >
      ...
      <div
        className={cn(
          "relative flex size-16 items-center justify-center rounded-2xl border border-border/50 bg-gradient-to-br from-background/90 to-muted/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition-all duration-300 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
